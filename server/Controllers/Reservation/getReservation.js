...
const getReservation = async (req, res) => {
    ...
    try {
        ...
        if (errorsArray.length > 0) {
            ...
            await logEntry({
                message: "Rezervasyon gösterilirken hatalı veri girildi ve işlem yapılamadı.",
                employee,
        ...
        await logEntry({
            message: "Rezervasyon gösterildi.",
            employee,
            request: requestDetails,
        ...
        await logEntry({
            message: "İşlem sırasında hata oluştu. Rezervasyon gösterilemedi.",
            level: "error",
            employee,
            request: requestDetails,
